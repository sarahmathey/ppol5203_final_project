...
mmr_viz<-plot_usmap(data = state_data
  ...
  scale_fill_continuous(low = "black", high = "#c900ff", name = "Maternal Mortality (2019)", label = scales::comma) + 
  labs(title = "Maternal Mortality Rates by State (2019)", caption = "Source: Institute for Health Metrics and Evaluation https://vizhub.healthdata.org/subnational/usa")+
